...
|> Section
    ...
    *Definitions.*
    ...
    is the slope of the graph $y = f(x)$ at $x = a$.
    And—surprise!—each pair of graphs above is a 
    pair of the form $y = f(x)$ [$=$ “before”],
    $y = f'(x)$ [$=$ “after”]. (Meaning, the “after”
    graph records the slope of the “before” graph.) 
    E.g.:
    ...
    there is a well-defined tangent line to $y = f(x)$
    at $x = a$ the slope of this tangent line 
    supplies the value of $f'(a)$:
...
|> Section
    ...
    *Sketching a Derivative.
    ...
    is positive and negative, and then to interpolate
    via the largest (respectively, smallest) value of
...
|> Section
    ...
    *Derivative of a constant function.*
    ...
    |> ImageLeft
        src svg_ch4_constant_derivative_cloud.svg
...
|> Section
    ...
    *Derivative of an affine function.*
    ...
    |> ImageLeft
        src svg_ch4_affine_derivative_cloud.svg
...
|> Section
    ...
    *Note.*
    ...
    The exotic units
		...
		of m$/$s per second. (Acceleration <i>is</i> a number of m$/$s per second, 
		no?)

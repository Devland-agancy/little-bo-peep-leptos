        ...
        <Tabs labels=vec!["1", "2"]>
             <TabElement > 
                ...
                <Solution>
                    ...
                    <ImageLeft attached_to="sqrt-2" src="/images/18.svg" translate="(10px, 48px)" absolute=true top=730 left=-443 hidden_in_mobile=true squiggle_right="0" squiggle_top="36%">""</ImageLeft>
                    <Paragraph>

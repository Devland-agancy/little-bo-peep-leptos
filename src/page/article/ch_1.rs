        ...
        <Tabs labels=vec!["1", "2"]>
             <TabElement >
                ...
                <Solution>
                    ...
                    <ImageLeft attached_to="sqrt-1" src="/images/17.svg" translate="(30px, 50px)" absolute=true top=480 left=-361 hidden_in_mobile=true squiggle_right="-0.9rem" squiggle_top="30%">""</ImageLeft>
                    <Paragraph >
                        "and"
                    </Paragraph>
                    ...
                    <ImageLeft attached_to="sqrt-2" src="/images/18.svg" translate="(10px, 48px)" absolute=true top=730 left=-443 hidden_in_mobile=true squiggle_right="-1.1rem" squiggle_top="36%">""</ImageLeft>
                    <Paragraph>
             ...
             <TabElement >
                ...
                <Paragraph classes="animate-appear-slow">
                    "is "<Span italic=true>"roughly"</Span><Math>r#"$ 1/n^2 $"#</Math>" for large "<Math>r#"$ n $"#</Math>". But how far off
                    is this exactly? (I.e., what is the difference between "<Math>r#"${1 \over n} - {1 \over n+1}$"#</Math>" and "<Math>r#"${1 \over n^2}$"#</Math>"$?) And "<Span italic=true>"roughly"</Span>" how much is this far-offness, for large "<Math>r#"$n$"#</Math>"?"
                </Paragraph>

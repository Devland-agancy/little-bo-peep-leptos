...
fn ArticleBody(cx: Scope) -> impl IntoView {
    view! { cx,
      <Columns>
        <Tabs     labels=vec!["0", "1", "2", "3"] > "" <TabElement > "" <Paragraph              classes="animate-appear-slow" > "" r#""#<Span bold=true>r#"Exercise 1. "#</Span>r#" True or false: Lines of slope "#<Math>r#"$ -1 \over 2 $"#</Math>r#" are perpendicular to lines of slope "#<span class="nobreak"><Math>r#"$2$"#</Math>r#"."#</span>r#""# </Paragraph > <Solution > "" <Paragraph > "" r#"This is true, as illustrated by the following pair of lines:"# <Image                     src="/images/55.svg" /> <ImageRight                     src="/images/56.svg"                     width=340                     pos_x="3rem"                     pos_y="15rem" > "" </ImageRight> <ImageLeft                     src="/images/57.svg"                     width=340                     pos_x="13rem"                     pos_y="19rem" > "" </ImageLeft> </Paragraph> <Paragraph > "" r#"In more detail, the two triangles are related by a "#<Math>r#"$90^\circ$"#</Math>r#" rotation and so, likewise, are the lines defined by their hypotenuses!"# </Paragraph> <Paragraph                 margin_top=15 > "" r#""#<Span italic=true>r#"Note 1."#</Span>r#"  More generally, a line of slope "#<Math>r#"$p$"#</Math>r#" is perpendicular to a line of slope "#<span class="nobreak"><Math>r#"$-1/p$"#</Math>r#","#</span>r#" for all "#<span class="nobreak"><Math>r#"$p \ne 0$"#</Math>r#"."#</span>r#" By a similar drawing, for "#<span class="nobreak"><Math>r#"$p > 0$"#</Math>r#":"#</span>r#""# <Image                     src="/images/58.svg" /> <ImageRight                     src="/images/59.svg"                     width=340                     pos_x="3rem"                     pos_y="20rem" > "" </ImageRight> <ImageLeft                     src="/images/60.svg"                     width=340                     pos_x="11rem"                     pos_y="23rem" > "" </ImageLeft> </Paragraph> <Paragraph > "" r#"If you're curious, a drawing for the case "#<span class="nobreak"><Math>r#"$p < 0$"#</Math>r#"..."#</span>r#""# <Image                     src="/images/61.svg" /> </Paragraph> <Paragraph > "" r#"...is like so, but it doesn't really add anything new. "# </Paragraph> </Solution> </TabElement> <TabElement > "" <Paragraph              classes="animate-appear-slow" > "" r#""#<Span bold=true>r#"Exercise 2. "#</Span>r#" Find the general equation of a line of slope  "#<Math>r#"$p$"#</Math>r#" passing through a point "#<span class="nobreak"><Math>r#"$(x_0, y_0)$"#</Math>r#"."#</span>r#" (Hint: Start from the slope formula.) "# </Paragraph > <Solution > "" <Paragraph > "" r#"A point "#<Math>r#"$(x,y) \ne (x_0,y_0)$"#</Math>r#" is on the line of slope "#<Math>r#"$p$"#</Math>r#" if and only if "#<MathBlock>r#"$$ p = {y - y_0 \over x - x_0} $$"#</MathBlock>r#" because "#<MathBlock>r#"$$ \,\,{y - y_0 \over x - x_0} $$"#</MathBlock>r#" is the slope of the line segment from "#<Math>r#"$(x_0,y_0)$"#</Math>r#"  to "#<span class="nobreak"><Math>r#"$(x,y)$"#</Math>r#","#</span>r#" and it is necessary and sufficient for this segment to have slope "#<Math>r#"$p$"#</Math>r#" in order for the point "#<Math>r#"$(x,y)$"#</Math>r#" to be on the line!"# <Paragraph                     indent=Indent::Line > "" r#"Unfortunately, the equation"# </Paragraph> r#""#<MathBlock>r#"$$ p = {y - y_0 \over x - x_0} $$"#</MathBlock>r#" is not an entirely satisfactory answer, because the point "#<Math>r#"$(x,y) = (x_0,y_0)$"#</Math>r#" itself does not satisfy the equation. (We find "#<MathBlock>r#"$$ p = {0 \over 0} $$"#</MathBlock>r#" if we plug in "#<span class="nobreak"><Math>r#"$x = x_0$"#</Math>r#","#</span>r#" "#<span class="nobreak"><Math>r#"$y = y_0$"#</Math>r#","#</span>r#" which is not a valid equality because the right-hand side is an undefined quantity.)"# <Paragraph                     indent=Indent::Line > "" r#"Instead, multiplying"# </Paragraph> r#""#<MathBlock>r#"$$ p = {y - y_0 \over x - x_0} $$"#</MathBlock>r#" on both sides by "#<span class="nobreak"><Math>r#"$x-x_0$"#</Math>r#","#</span>r#" we find the fraction-less equation "#<MathBlock>r#"$$ p(x-x_0) = y-y_0 $$"#</MathBlock>r#" which is satisfied by the point "#<Math>r#"$(x,y) = (x_0,y_0)$"#</Math>r#" as well as by every other point on the line. This can be a final answer, and, pleasingly, has the form"# <MathBlock > "" r#"$$\te{“}\te{slope} \times \te{run} = \te{rise}\te{”}$$    "# <ImageRight                         src="/images/63.svg"                         width=400                         pos_x="-1.3rem"                         pos_y="-1.6rem"                         hidden_in_mobile=true                         squiggle_top="36%"                         squiggle_left="-2.5rem" > "" </ImageRight> </MathBlock> r#"which can also make it easy to remember!"# </Paragraph> <Paragraph                 margin_top=15 > "" r#""#<Span italic=true>r#"Note 1."#</Span>r#" The answer we gave is more often written "#<MathBlock>r#"$$ y - y_0 = p(x - x_0) $$"#</MathBlock>r#" with the two sides of the equation swapped, or "#<MathBlock>r#"$$ y = p(x - x_0) + y_0 $$"#</MathBlock>r#" with "#<Math>r#"$y$"#</Math>r#" isolated on the left-hand side. From there one can also distribute "#<span class="nobreak"><Math>r#"$p(x-x_0)$"#</Math>r#","#</span>r#" obtaining (after putting “"#<span class="nobreak"><Math>r#"$-px_0$"#</Math>r#"”  "#</span>r#" last) "#<MathBlock>r#"$$ y = px + y_0 - px_0 $$"#</MathBlock>r#" which has the form "#<MathBlock>r#"$$ y = ax + b $$"#</MathBlock>r#" with "#<span class="nobreak"><Math>r#"$a = p$"#</Math>r#","#</span>r#" "#<span class="nobreak"><Math>r#"$b = y_0 - px_0$"#</Math>r#"."#</span>r#"    "# </Paragraph> </Solution> </TabElement> <TabElement > "" <Paragraph              classes="animate-appear-slow" > "" r#""#<Span bold=true>r#"Exercise 3. "#</Span>r#" Plot the vertical velocity of an object a mosquito whose height over time is given by this graph (use the same time interval as the graph):"# </Paragraph > <Image             src="/images/1.svg" /> <Solution > "" <Paragraph > "" r#"Here is the “official” graph of the (vertical) velocity:    "# </Paragraph> <Image                 src="/images/64.svg" /> <Paragraph                 indent=Indent::Line > "" r#"On each interval, the velocity is rate of change of the height, i.e., the "#<Span italic=true>r#"slope"#</Span>r#" of the height. For example, the rate of change of the height is "#<MathBlock>r#"$$ {1\te{m} \over 1\te{s}} = 1\te{m}/\te{s} $$"#</MathBlock>r#" between "#<span class="nobreak"><Math>r#"$-4$"#</Math>r#"s"#</span>r#" and "#<span class="nobreak"><Math>r#"$-3$"#</Math>r#"s,"#</span>r#" where the mosquito goes up by one meter during a one second period, so the vertical velocity is 1m"#<span class="nobreak"><Math>r#"$/$"#</Math>r#"s"#</span>r#" for that time interval, etc."# </Paragraph> <Paragraph                 margin_top=15 > "" r#""#<Span italic=true>r#"Note 1."#</Span>r#" As explained in Chapter 3, an empty circle of this type"# </Paragraph> <Image                 src="/images/65.svg"                 width="30px" /> <Paragraph > "" r#"indicates a “missing” value.  Specifically, in our case, the vertical velocity is "#<Span italic=true>r#"undefined"#</Span>r#" wherever the graph of the height has a sharp corner. (Because the slope of the graph is not well-defined at such corners.)    "# </Paragraph> <Paragraph                 margin_top=15 > "" r#""#<Span italic=true>r#"Note 2."#</Span>r#"  For the time interval from "#<span class="nobreak"><Math>r#"$2$"#</Math>r#"s"#</span>r#" to "#<span class="nobreak"><Math>r#"$2.5$"#</Math>r#"s,"#</span>r#" the slope is "#<MathBlock>r#"$$ {-2\rt{0.05}\te{m} \over 0.5\rt{0.05}\te{s}} = -\rt{0.07}4\rt{0.1}\te{m}/\te{s} $$"#</MathBlock>r#" and similarly for the time interval  from "#<span class="nobreak"><Math>r#"$2.5$"#</Math>r#"s"#</span>r#" to "#<span class="nobreak"><Math>r#"$3$"#</Math>r#"s"#</span>r#" the slope is "#<MathBlock>r#"$$ {2\rt{0.05}\te{m} \over 0.5\rt{0.05}\te{s}} = 4\rt{0.1}\te{m}/\te{s} $$"#</MathBlock>r#" because "#<span class="nobreak"><Math>r#"$2/0.5 = 4$"#</Math>r#"."#</span>r#" (Think: "#<Span italic=true>r#"how many times"#</Span>r#" does "#<Math>r#"$0.5$"#</Math>r#" go into "#<span class="nobreak"><Math>r#"$2$"#</Math>r#"?)"#</span>r#""# </Paragraph> </Solution> </TabElement> <TabElement > "" <Paragraph              classes="animate-appear-slow" > "" r#""#<Span bold=true>r#"Exercise 4. "#</Span>r#" Digressing on the second-to-last equation in the solution to Exercise 2, explain why "#<MathBlock>r#"$$ y_0 - px_0 $$"#</MathBlock>r#" is the "#<span class="nobreak"><Math>r#"$y$"#</Math>r#"-intercept"#</span>r#" of the line of slope "#<Math>r#"$p$"#</Math>r#" through the point "#<Math>r#"$(x_0,y_0)$"#</Math>r#" by using a drawing and “rise equals slope times run”.    "# </Paragraph > <Solution > "" <Paragraph > "" r#"E.g.:"# </Paragraph> <Image                 src="/images/66.svg"                 width="640px" /> <Paragraph > "" r#"The rise from the "#<span class="nobreak"><Math>r#"$y$"#</Math>r#"-intercept"#</span>r#" to "#<Math>r#"$(x_0, y_0)$"#</Math>r#" is "#<span class="nobreak"><Math>r#"$px_0$"#</Math>r#","#</span>r#" as found by “rise equals slope times run”, implying that "#<MathBlock>r#"$$ y_0 - px_0 $$"#</MathBlock>r#" is the "#<span class="nobreak"><Math>r#"$y$"#</Math>r#"-intercept."#</span>r#"    "# r#""#<Span italic=true>r#"Note 1."#</Span>r#" Our drawing makes some implicit assumptions, such as "#<Math>r#"$p > 0$"#</Math>r#" and "#<span class="nobreak"><Math>r#"$x_0 > 0$"#</Math>r#"."#</span>r#" But "#<MathBlock>r#"$$ px_0 $$"#</MathBlock>r#" is the rise from the "#<span class="nobreak"><Math>r#"$y$"#</Math>r#"-intercept"#</span>r#" to "#<Math>r#"$(x_0, y_0)$"#</Math>r#" regardless of the sign of "#<Math>r#"$p$"#</Math>r#" or "#<Math>r#"$x_0$"#</Math>r#" (because “"#<span class="nobreak"><Math>r#"$x_0$"#</Math>r#"”  "#</span>r#" is the run in all cases), making "#<MathBlock>r#"$$ y_0 - px_0 $$"#</MathBlock>r#" the "#<span class="nobreak"><Math>r#"$y$"#</Math>r#"-intercept"#</span>r#" in all cases.    "# </Paragraph> </Solution> </TabElement> </Tabs>
        <Paragraph>

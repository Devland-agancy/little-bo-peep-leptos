...
#[prop(default = "")] containerClasses: &'static str , #[prop(default = "")] imageClasses: &'static str) -> impl IntoView {
    ...
    view! {cx,
        <div
            class=move || format!("px-4 my-10 relative col-start-2 scrollbar-hidden md:overflow-x-visible {}", containerClasses)
        ...
        >
            <img
                ...
                class=move || format!("max-w-none md:absolute md:-translate-x-1/2 md:left-1/2 m-auto {}", imageClasses)
            />
        </div>
